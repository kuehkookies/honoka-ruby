...
#
# Here defined the Player object and its methods, behaviors and available actions.
# ==================================================================================
class Player < Chingu::GameObject
	...
	def setup
		...
		# Without this, Player can't stand on very ground.
		cache_bounding_box
	end
	

	# Reset player's flags. Useful when respawning Player on Scene.
	def reset_state
